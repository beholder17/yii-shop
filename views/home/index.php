        ...
        <div class="container">
            ...
            <div class="agile_top_brands_grids">
                <? foreach ($offers as $offer) {
                    $link = \yii\helpers\Url::to(['product/view', 'id' => $offer['id']]);
                    ?>
                                    ...
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="<?= $link ?>">
                                                    <?= Html::img('@web/images/' . $offer['img'], ['class' => 'img-responsive', 'alt' => $offer['title']]) ?>
                                                </a>
                                                <p><?= $offer['title'] ?></p>
                                                <?
                                                if ($offer['price'] > 0) {
                                                    if ($offer['old_price'] > 0) { ?>
                                                        <h4><?= $offer['price'] ?> ₽ <span><?= $offer['old_price'] ?> ₽</span></h4>
                                                    <? } else { ?>
                                                        <h4><?= $offer['price'] ?> ₽ </h4>
                                                    <? } ?>
                                                <? } ?>
